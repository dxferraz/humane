...
@InputType()
export class UsersOnChatRoomUncheckedUpdateManyWithoutUserInput {
    ...
    @Field(() => [UsersOnChatRoomUpsertWithWhereUniqueWithoutUserInput], {
        nullable: true,
    })
    ...
    @Field(() => [UsersOnChatRoomUpdateWithWhereUniqueWithoutUserInput], {
        nullable: true,
    })
    update?: Array<UsersOnChatRoomUpdateWithWhereUniqueWithoutUserInput>;

    @Field(() => [UsersOnChatRoomUpdateManyWithWhereWithoutUserInput], {
        nullable: true,
    })
