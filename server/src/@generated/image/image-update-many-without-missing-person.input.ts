...
@InputType()
export class ImageUpdateManyWithoutMissingPersonInput {
    ...
    @Field(() => [ImageUpsertWithWhereUniqueWithoutMissingPersonInput], {
        nullable: true,
    })
    ...
    @Field(() => [ImageUpdateWithWhereUniqueWithoutMissingPersonInput], {
        nullable: true,
    })
    update?: Array<ImageUpdateWithWhereUniqueWithoutMissingPersonInput>;

    @Field(() => [ImageUpdateManyWithWhereWithoutMissingPersonInput], {
        nullable: true,
    })
