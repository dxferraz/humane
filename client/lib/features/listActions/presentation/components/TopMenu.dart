            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  const SizedBox(
                    width: 36,
                    child: AnimatedSwitcher(duration: Duration(milliseconds: 500), child: const Icon(Icons.history, key: Key('history'))),
                  ),
                  ...
                  InkWell(
                    ...
                    child: const SizedBox(
                      width: 45,
                      height: 50,
                      child: AnimatedSwitcher(duration: Duration(milliseconds: 500), child: const Icon(Icons.close)),
                    ),
                  ),
                ],
              ),
